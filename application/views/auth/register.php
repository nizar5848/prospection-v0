<div class="wrapper vh-98 p-5">
    <div class="row align-items-center h-100">
        <?php echo form_open('AuthController/register', [
            'class' => 'col-lg-6 col-md-8 col-10
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email"
                   id="inputEmail4" value="<?php echo set_value('email'); ?>"
                   required>
        ...
        <?php if ($is_admin_exists): ?>
            <div class="form-group">
                ...
                <div>
                    <label class="radio-inline mr-5"><input type="radio"
                                                            name="role"
        ...
        <button class="btn btn-lg btn-primary btn-block"
                type="submit"><?php echo $is_admin_exists ? 'Sign up' : 'S\'inscrire'; ?></button>

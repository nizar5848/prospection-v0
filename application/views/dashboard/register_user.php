...
<div class="centered-container vh-98">
    <div class="card">
        <div class="mx-auto text-center">
            ...
            <h3 class="my-3"><i class="fas fa-user-plus"></i><?php echo $is_admin_exists ? ' '.'Créer Utilisateur' : 'Inscription'; ?></h3>
        </div>
        <hr class="my-3">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback text-left">Veuillez entrer mot de passe avec les exigences recommendés.</div>
                    </div>
                    <div class="form-group">

...
<div class="centered-container">
    <div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" id="company" name="company" class="form-control" value="<?php echo set_value('company'); ?>" required>
        ...
        <div class="form-group">
            ...
            <input type="tel" id="phone_number" name="phone_number" class="form-control" value="<?php echo set_value('phone_number'); ?>" required>
            <div class="invalid-feedback text-left">Veuillez saisir le numéro du téléphone.</div>
        </div>

        <div class="form-group">
            <label for="address">Adresse</label>
            <textarea rows="5" class="form-control" name="address" id="address" required><?php echo set_value('address'); ?></textarea>

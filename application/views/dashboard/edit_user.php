...
<div class="wrapper vh-98">
    ...
    <div class="row align-items-center h-100">
        <div class="card col-lg-6 col-md-8 col-10 mx-auto needs-validation"
             style="border: 1px solid #e0e0e0; border-radius: 20px;">
            ...
            <div class="card-body">
                <div class="mx-auto text-center flex">
                    ...
                    <h3 class="my-2">Modifier Commercial</h3>
                    <hr>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 password-requirements">
                        ...
                        <p class="small text-muted mb-2">Pour créer un nouveau mot de passe, vous devez remplir toutes
                            les
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="role"
                                       value="user" <?php echo $user['role'] == 'user' ? 'checked' : ''; ?>> Commercial
                            </label>
                        </div>
                    </div>
                <?php endif; ?>

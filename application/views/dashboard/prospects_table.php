...
<div class="container mt-4">
    ...
    <!--start 2 cards-->
    <button class="btn btn-primary mb-3" data-toggle="collapse" data-target="#toggleContent"
            aria-expanded="false" aria-controls="toggleContent">
        Afficher / Masquer Options
    </button>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url('ProspectController/exportToExcel'); ?>">
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <button type="submit" class="btn btn-success mt-4 text-white">Exporter</button>
                            </div>
                        </form>
